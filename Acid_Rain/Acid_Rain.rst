...
We want to find ANC0 such that ANCout = 50 畫q/L when t is equal to ?. Solving for ANC0 we get:
...
The most common remediation procedure is to apply the neutralizing agent directly to the lake surface, instead of on the watershed. We will follow that practice in this lab experiment. Sodium bicarbonate will be added directly to the surface of the lake that has an initial ANC of 0 畫q/L and is receiving acid rain with a pH of 3. After the sodium bicarbonate is applied, the lake pH and ANC will be monitored for over two approximately 20 minute periods.
...
\noindent \begin{enumerate}
\item 1) )How many grams of NaHCO3 would be required to keep the ANC levels in a lake above 50 畫q/L for 3 hydraulic residence times given an influent pH of 3.0 and a lake volume of 4 L, if the current PlaceTypeplacelake PlaceNameANC is 0 畫q/L?
\end{enumerate}
...
\noindent \begin{enumerate}
\item 1) )What do you think would happen if enough NaHCO${}_{3}$ were added to the lake to maintain an ANC greater than 50 畫q/L for 3 residence times with the stirrer turned off? How much NaHCO${}_{3}$ would need to be added? 
...
\noindent \item ? 搪xtent of mixing

\noindent \item ? 新olubility of CaCO3 (find the solubility and compare with NaHCO${}_{3}$)

\noindent \item ? 搞ensity of CaCO3 slurry (find the density of CaCO3)
\end{enumerate}
...
100-1095 無 pipette & Fisher Scientific & 13-707-5 \\ \hline 
10-109.5 無 pipette & Fisher Scientific & 13-707-3 \\ \hline 
