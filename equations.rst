...
.. csv-table:: Equation formats
    ...
    67, `MInor loss <https://aguaclara.github.io/Textbook/Review/Review_Fluid_Mechanics_Derivations.html#equation-minor-loss-equation>`_, :math:`\quad h_e = \left( \frac{A_{out}}{A_{in}} -1 \right)^2 \, \frac{\bar v_{out}^2}{2g} \, \, = \, \, K_e \frac{\bar v_{out}^2}{2g}, \quad {\rm where} \quad K_e = \left( \frac{A_{out}}{A_{in}} - 1 \right)^2 }`, 2
