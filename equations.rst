...
.. csv-table:: Equation formats
    ...
    7, `Reynolds number  <https://aguaclara.github.io/Textbook/Review/Review_Fluid_Mechanics.html#equation-reynolds-number-equation>`_, :math:`{\rm Re} = \frac{\bar vD}{\nu} = \frac{4Q}{\pi D\nu} = \frac{\rho \bar vD}{\mu}`, 2
    ...
    67, `MInor loss  <https://aguaclara.github.io/Textbook/Review/Review_Fluid_Mechanics_Derivations.html?highlight=minor%20loss#equation-minor-loss-equation>`_, :math:`{\rm{ \mathbf{Third \, form:} }} \quad h_e = \left( \frac{A_{out}}{A_{in}} -1 \right)^2 \, \frac{\bar v_{out}^2}{2g} \, \, = \, \, K_e \frac{\bar v_{out}^2}{2g}, \quad {\rm where} \quad K_e = \left( \frac{A_{out}}{A_{in}} - 1 \right)^2 }`, 2
