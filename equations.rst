...
.. csv-table:: Equation formats
    ...
    473, `Jet velocity <https://aguaclara.github.io/Textbook/Sedimentation/Sed_Design.html#equation-max-sed-tank-jet-velocity>`_, :math:`\bar v_{Jet} = \left(\frac{\tau_{max}}{\rho}\right)^\frac{1}{2} \left( \frac{\bar v_{z_{ff}} W_{Sed}}{\nu \Pi_{JetPlane}}\right)^\frac{1}{4}`, 9
    ...
    549, `Floc filter head loss <https://aguaclara.github.io/Textbook/Sedimentation/Sed_Derivations.html#equation-sedimentation-sed-derivations-65>`_, :math:`h_L = H_{ff} \left( \frac{\rho_{clay}}{\rho_{H_2O}} - 1 \right) \frac{C_{clay}}{\rho_{clay}}`, 9
    560, `Diffuser width <https://aguaclara.github.io/Textbook/Sedimentation/Sed_Derivations.html#equation-sedimentation-sed-derivations-76>`_, :math:`W_{diff_min} = \frac{\bar v_{z_{ff}}W_{Sed}B_{diff}}{(\sqrt{2gh_{L_jet}})S_{diff}}`, 9
