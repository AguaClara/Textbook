...
Edit the configurations to create new models of the flocculator. Some models may fail because the constraints can't all be met. Send us |feedback| to share how you are using the Flocculator HV model and to give us suggestions for how to make these models easier to use.
